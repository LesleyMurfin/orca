...
export default function SortableTab({
  ...
  // Why: while editing or pinned, suppress dnd-kit drag listeners. Editing
  // protects the inline input; pinning makes the tab's left-edge position fixed.
  // Keep attributes for dnd-kit's a11y metadata.
  const dragListeners = isEditing || isPinned ? undefined : listeners
