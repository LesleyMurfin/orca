...
export const SERVE_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    usage:
      'orca serve [--port <port>] [--pairing-address <host>] [--mobile-pairing] [--no-pairing] [--project-root <path>] [--recipe-json] [--json] [--verbose]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'port',
      'pairing-address',
    ...
    notes: [
      ...
      'Use --verbose to emit Electron/Chromium verbose logging to stderr (renderer, GPU, and network detail) for headless troubleshooting.',
