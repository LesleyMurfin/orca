...
const bitbucketForgeProvider = {
  id: 'bitbucket',
  supportsReviewCreation: false,
  resolveRepository: ({ repoPath }) => getBitbucketRepoSlug(repoPath),
  async getReviewForBranch(input) {
...
const azureDevOpsForgeProvider = {
  id: 'azure-devops',
  supportsReviewCreation: false,
  resolveRepository: ({ repoPath }) => getAzureDevOpsRepoSlug(repoPath),
  async getReviewForBranch(input) {
...
const giteaForgeProvider = {
  id: 'gitea',
  supportsReviewCreation: false,
  resolveRepository: ({ repoPath }) => getGiteaRepoSlug(repoPath),
  async getReviewForBranch(input) {
